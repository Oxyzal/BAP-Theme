...
<footer class="footer">
    ...
    <p class="lp-footer">
        ...
        <div class="imgfoot">
            <a href="#"><img class="img-footer" src="wp-content/uploads/2022/04/linkedin.png" alt=""></a>
            <a class="space-left" href="#"><img class="img-footer" src="wp-content/uploads/2022/04/facebook.png" alt=""></a>
